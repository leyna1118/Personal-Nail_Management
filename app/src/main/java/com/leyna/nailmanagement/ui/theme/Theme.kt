...
private fun colorSchemeFromSeed(seedArgb: Int, isDark: Boolean): ColorScheme {
    ...
    return if (isDark) {
        ...
        lightColorScheme(
            ...
            primaryContainer = hslColor(hue, sat * 0.25f, 0.92f),
            ...
            surfaceContainerLowest = hslColor(hue, sat * 0.01f, 1.0f),
            surfaceContainerLow = hslColor(hue, sat * 0.02f, 0.99f),
            surfaceContainer = hslColor(hue, sat * 0.03f, 0.98f),
            surfaceContainerHigh = hslColor(hue, sat * 0.04f, 0.97f),
            surfaceContainerHighest = hslColor(hue, sat * 0.05f, 0.96f),
